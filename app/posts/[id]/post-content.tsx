...
export default function PostContent({ post }: PostContentProps) {
  ...
  const renderContent = () => {
    // Implementação simples e segura para renderizar HTML
  ...
  return (
    <article>
      ...
      {/* Conteúdo do post usando dangerouslySetInnerHTML em vez de html-react-parser */}
      <div className="prose prose-invert prose-red max-w-none mb-8 editor-content">{renderContent()}</div>
